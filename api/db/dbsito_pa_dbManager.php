...
function getConnection() {
	...
	global $db_sito_pa_db_Url, $db_sito_pa_db_User, $db_sito_pa_db_Pass, $db_sito_pa_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_sito_pa_db_Url.";dbname=".$db_sito_pa_db_DbName, $db_sito_pa_db_User, $db_sito_pa_db_Pass);
